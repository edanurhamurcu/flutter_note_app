        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Card(
                color: themeProd.isDarkMode ? Colors.black38 : Colors.white,
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ListTile(
                    ...
                    SwitchListTile(
                      ...
                      subtitle: themeProd.isDarkMode
                          ? Text(LocaleKeys.setting_dark_mode.tr())
                          : Text(LocaleKeys.setting_light_mode.tr()),
                      secondary: themeProd.isDarkMode
                          ? Icon(Icons.brightness_4)
                          : Icon(Icons.brightness_7),
                      value: themeProd.isDarkMode,
                      onChanged: (bool value) {
                        themeProd.toggleTheme();
                        setState(() {});
                      },
                    ),
                  ],
